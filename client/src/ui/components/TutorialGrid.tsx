...
const TutorialGrid: React.FC<GridProps> = forwardRef(({
  ...
  const handleMouseDown = (e: React.MouseEvent, block: Block) => {
    ...
    //     if (tutorialStep && tutorialTargetBlock) {
    //   if (dragging?.x !== tutorialTargetBlock.x || dragging.y !== tutorialTargetBlock.y) {
    //     return;
    //   }
    // }
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    // if (tutorialStep && tutorialTargetBlock) {
    //   if (
    //     dragging?.x !== tutorialTargetBlock.x ||
    //     dragging.y !== tutorialTargetBlock.y
    //   ) {
    //     return;
    //   }
    // }
